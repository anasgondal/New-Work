...
class Frcs2Question extends Component {
    constructor(props) {
        super(props);
        this.state = {
            totalearning: "",
...
export default connect(mapStateToProps, mapDispatchToProps)(Frcs2Question);
