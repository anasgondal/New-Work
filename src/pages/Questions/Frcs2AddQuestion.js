...
class Frcs1AddQuestion extends Component {
    ...
    render() {
        ...
        return (
            <div className="oral-clinical-sec">
...
<div className="col-md-6 anas ">
    ...
    <div className="col-md-6 mt-4 anas">
        ...
        <button className="oral-btn" onClick={() => this.onclickBtn('oral')}>ORAL</button>
        
        <button className="clinical-btn" onClick={() => this.onclickBtn('clinical')}>CLINICAL</button>
...
<div className="col-md-12 anas mt-2 ">
        ...
        <textarea type="text" className="question-box-full" placeholder="Please Enter Answer"></textarea>
             ...
             <div className="row p-0 mt-3">
<div className="col-md-12 anas mt-2 ">
        <p className="poppins_regular test-type">Point for Discussion  <label className="staric">*</label></p>
        <textarea type="text" className="question-box-full" placeholder="Please Enter Point for Discussion "></textarea>
         </div>
             </div>
...
{this.state.clickedBtn === 'clinical' && 
